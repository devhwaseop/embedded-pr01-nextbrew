...
export const EVENTS = {
  ...
  'bean.save': '원두 저장 — data: { beanId, name, nameAuto(이름 자동 조합), status(active|consumed), totalG(구매 무게 g · 섞은 블렌드는 섞은 무게 합), remainingG(남은 원두 추정 g), kind(single|roaster|me, 9/26), parts(블렌드 구성 수) }',
