...
const FONT_SIZE_EXEMPT = {
  ...
  '.ring-pour': '타이머: 원 안 빨간 알약 「7초 · 42g」 — 원 크기에 비례(9/25)',
  '.ring-unit': '타이머: 큰 숫자 옆 작은 「초」 — 원 크기에 비례(9/25)',
  '.ring-target': '타이머: 원 안 맨 아래 「100g까지」 — 원 크기에 비례(9/25)',
  '.step-name': '타이머: 원 밖 단계 이름 — 멀리서 보게 크게, 화면 높이에 비례(9/25)',
